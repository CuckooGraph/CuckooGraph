...
private:
	...
	int halfR;
	int rper;
	unsigned int* fvalue;	int *fper;	Blizzard_MPQ *mpq;
	...
	public:
		...
		~Auxo()
		{
		 ...
		 int nodeValueQuery(string s1, int type, double& queryMatrix);		 int nodeDegreeQuery(string s1, int type);		 void nodeSuccessorQuery(string s1, vector<string> &IDs);
