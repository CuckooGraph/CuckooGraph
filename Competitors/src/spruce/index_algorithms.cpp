...
#pragma omp parallel for schedule(guided) num_threads(NUM_THREADS)
    ...
    total_insert_time.store(total_insert_time + ((end.tv_sec - start.tv_sec) * 1000000000 + end.tv_nsec - start.tv_nsec));
    // total_insert_time += std::atomic<double>((end.tv_sec - start.tv_sec) * 1000000000 + end.tv_nsec - start.tv_nsec);
}
